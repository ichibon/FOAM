...
import { AnimatedSection, HoverCard, FeatureCheck, SectionLabel, StatusChip } from './shared.jsx';
...
export function FoamAudienceRouter() {
  return (
...
export function FoamHowItWorks() {
...
export function FoamProductFeature() {
  const [panel, setPanel] = useState('mobile');
  const [visible, setVisible] = useState(true);
