...
export default function AddTeamMemberScreen() {
  ...
  const currentMode: InputMode = detectMode(currentInput);
    ...
    <SafeAreaView style={styles.safeArea}>
        ...
        {activeTab === "invite" ? (
          <View style={styles.inviteForm}>
            <View style={styles.sectionBlock}>
              <Text style={styles.sectionLabel}>INVITE BY PHONE OR EMAIL</Text>

              <View style={styles.inputAddRow}>
                <View style={styles.inputWithIconWrap}>
                  <View style={styles.inputIconLeft}>
                    <Ionicons
                      name={currentMode === "phone" ? "call-outline" : "at-outline"}
                      size={17}
                ...
                <View style={styles.recipientList}>
                  {recipients.map((r) => (
                    <View key={r.id} style={styles.recipientChip}>
                      <Ionicons
                        name={r.mode === "phone" ? "call-outline" : "at-outline"}
                        size={13}
                      ...
                      <TouchableOpacity
                        ...
                        activeOpacity={0.7}
                      >
                        <Ionicons name="close" size={13} color={Colors.light.textTertiary} />
                      </TouchableOpacity>
                    </View>
                  ))}
                </View>
            ...
            <View style={styles.sectionBlock}>
              ...
              <Text style={styles.fieldHint}>
                Their share of each completed job's service fee.
              </Text>
            </View>

            {error && (
              <View style={styles.errorBanner}>
                <Ionicons name="alert-circle-outline" size={15} color={Colors.warningLight} />
          ...
          <View style={styles.codeTab}>
            <View style={styles.codeCard}>
              <View style={styles.codeIconCircle}>
                <Ionicons name="share-social-outline" size={28} color={Colors.foamBlue} />
              </View>
              <Text style={styles.codeTitle}>Share your code</Text>
              <Text style={styles.codeBody}>
                Your team member downloads the FOAM Crew app, enters this code, and is instantly
      ...
      {activeTab === "invite" && (
        <View style={styles.footer}>
          ...
          <Text style={styles.footerHint}>They'll receive a link to create their account.</Text>
        </View>
      )}
    </SafeAreaView>
  );
