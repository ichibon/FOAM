/* FOAM Landing — Nav, Hero, StatsBar */
...
/* ─── HERO CARDS (dark app mockups) ─── */
const TodaysJobsCard = () => (
...
/* ─── HERO ─── */
const FoamHero = ({ city = 'Atlanta' }) => (
  <section id="hero" style={{ background:'#FFFFFF', paddingTop:'clamp(100px,12vw,140px)', paddingBottom:'clamp(64px,8vw,100px)', padding:'clamp(100px,12vw,140px) clamp(20px,5vw,64px) clamp(64px,8vw,100px)' }}>
...
Object.assign(window, { FoamNav, FoamHero, FoamStatsBar });
